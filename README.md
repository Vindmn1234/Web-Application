...
## Front Note
### Collaboration
In this project, I(Jiazheng123) collaborated with Yanwei Wu and Tianyue Cong. Jiazheng was mainly in charge of developing the backend flask application. Yanwei was maninly responsible for developing the frontend REACT application. Tianyue was in charge of developing both the frontend and backend applications. 

### Use of AI Tools
We consulted ChatGPT and Claude throughout this project for directory organization, component design, functionality realization, and debugging. 
